...
- Bound independent Rust child definitions and launches to the hashed `max_children_per_action` profile limit, closing a parity gap where only slot capacity and nesting depth had been enforced.
