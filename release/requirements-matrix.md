...
| §18 freezes | domains, timing, expiry, stacking, accrual vectors | partial: Python and independent Rust agree on HOLD/ACCRUE progression plus PRE, POST, input-capture, and buffer-expiry domains; Python also has activation/expiry and provisional stacking, while the normative stacking gap remains open |
