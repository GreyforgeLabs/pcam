...
- `tests/vectors/action-runtime.json` drives independent Python and Rust runtime paths through rational progression, PRE_ADVANCE, AFTER_QUANTUM, POST_ADVANCE, priority selection, explicit seek, terminal entry, predicate dependencies and edge serials, invalid-definition rejection, and both per-tick progression limits.
