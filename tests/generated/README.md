...
It currently contains 232 cases:
...
Python and independent Rust both execute the same artifact. This is partial §39 coverage. Shared independent generation for parent-child structures remains open.
