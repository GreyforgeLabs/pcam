...
Python and independent Rust both execute the same artifact. This is partial §39 coverage. Shared independent generation for random action graphs, transition guards, freeze-token combinations, rollback corrections, and parent-child structures remains open.
