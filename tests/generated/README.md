...
It currently contains 208 cases:
...
Python and independent Rust both execute the same artifact. This is partial §39 coverage. Shared independent generation for rollback corrections and parent-child structures remains open.
